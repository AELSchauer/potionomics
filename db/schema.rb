...
ActiveRecord::Schema[7.0].define(version: 20_230_803_181_136) do
  ...
  create_table 'cupboard_ingredients', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[cupboard_id ingredient_id], name: 'index_cupboard_ingredients_on_cupboard_id_and_ingredient_id',
                                           unique: true
