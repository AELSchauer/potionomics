...
CSV.foreach('./db/fixtures/Perfect Recipes.csv', headers: true) do |row|
  ...
  matches = row['Recipe Summary'].split("\n").map do |data|
    data.match(/^(?<quantity>\d{1,2})x (?<name>[\w '-]*)$/)
  end
...
cupboard = Cupboard.create(highest_license_tier: 1, user:)

CupboardCauldron.create(cauldron: Cauldron.find_by(name: 'Wooden', tier: 1), active: false, cupboard:)
CupboardCauldron.create(cauldron: Cauldron.find_by(name: 'Clay', tier: 1), active: false, cupboard:)
CupboardCauldron.create(cauldron: Cauldron.find_by(name: 'Glass', tier: 3), active: false, cupboard:)
CupboardCauldron.create(cauldron: Cauldron.find_by(name: 'Storm', tier: 3), active: false, cupboard:)
CupboardCauldron.create(cauldron: Cauldron.find_by(name: 'Ocean', tier: 1), active: false, cupboard:)
CupboardCauldron.create(cauldron: Cauldron.find_by(name: 'Crystal', tier: 3), active: false, cupboard:)
CupboardCauldron.create(cauldron: Cauldron.find_by(name: 'Celestial', tier: 3), active: false, cupboard:)
CupboardCauldron.create(cauldron: Cauldron.find_by(name: 'Arctic', tier: 3), active: true, cupboard:)
CupboardCauldron.create(cauldron: Cauldron.find_by(name: 'Arctic', tier: 3), active: true, cupboard:)
CupboardCauldron.create(cauldron: Cauldron.find_by(name: 'Arctic', tier: 3), active: true, cupboard:)
CupboardCauldron.create(cauldron: Cauldron.find_by(name: 'Dragon', tier: 3), active: false, cupboard:)
CupboardCauldron.create(cauldron: Cauldron.find_by(name: 'Magical Wasteland', tier: 3), active: true,
                        cupboard: Cupboard.first)
